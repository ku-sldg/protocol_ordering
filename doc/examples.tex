...
\begin{center}
    \begin{tabular}{ M{3.75cm} | M{5cm} }
            ...
            \\  & \input{examples/vc-sys-seq/vc-sys-seq4.tex}  \\ [50pt] 
        \end{tabular}
    \end{center}
...
\begin{figure}
    \begin{center}
        \begin{tabular}{ M{3.75cm} | M{4.75cm} | M{3.75cm} }
                ...
                \hline
                \hline
                \\ \input{examples/sys/sys1.tex} & \input{examples/ker_vs-sys-seq/m1.tex} & \input{examples/rtm_ker-vc-sys-seq/m1.tex} \\ [50pt]
                \\ \input{examples/sys/sys2.tex} & \input{examples/ker_vs-sys-seq/m2.tex} & \input{examples/rtm_ker-vc-sys-seq/m2.tex}  \\ [50pt]  
                 & \input{examples/ker_vs-sys-seq/m3.tex}  & \input{examples/rtm_ker-vc-sys-seq/m3.tex} \\ [50pt]  
